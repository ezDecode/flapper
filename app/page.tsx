...
function LandingPageInner() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "#0B0B0F", color: "#E8E8EC" }}>
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            <button
              ...
              style={{
                background: "#E8590C",
                boxShadow: "0 0 30px rgba(232, 89, 12, 0.15)",
              }}
            >
              Start for free
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {steps.map((step) => (
              <div
                key={step.num}
                className="rounded-xl border p-8 transition-colors hover:border-[#2A2A34]"
                style={{
                  background: "#141419",
                  borderColor: "#1E1E26",
                }}
          ...
          <div className="grid items-start gap-4 md:grid-cols-3">
            {plans.map((plan) => (
              <div
                ...
                style={{
                  borderColor: plan.highlighted ? "#E8590C" : "#1E1E26",
                  background: "#141419",
                }}
              >
                {plan.highlighted && (
                ...
                <p
                  ...
                  style={{
                    color: plan.highlighted ? "#E8590C" : "#6B6B7B",
                  }}
                >
                  {plan.name}
                </p>
                  ...
                  {plan.features.map((feature) => (
                    ...
                    >
                      <Check
                        ...
                        style={{
                          color: plan.highlighted ? "#E8590C" : "#3B7A47",
                        }}
                      />
                      {feature}
                    </li>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    plan.highlighted
                      ...
                      : "border hover:border-[#2A2A34]"
                  )}
                  style={
                    plan.highlighted
                      ? { background: "#E8590C" }
                      : { borderColor: "#1E1E26", color: "#C8C8D0" }
                  }
                >
      ...
      {/* ─── FOOTER ─── */}
      <footer className="border-t px-6 py-10" style={{ borderColor: "#1E1E26" }}>
        <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex items-center gap-4">
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" style={{ color: "#4A4A58" }} className="transition-opacity hover:opacity-80">
              <i className="devicon-twitter-original text-sm" />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" style={{ color: "#4A4A58" }} className="transition-opacity hover:opacity-80">
              <i className="devicon-linkedin-plain text-sm" />
            </a>
            <span className="text-xs font-normal" style={{ color: "#4A4A58" }}>
              © 2026 Flapr
            </span>
          </div>
        </div>
