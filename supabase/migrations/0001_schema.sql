-- ============================================================
-- 0001_schema.sql  –  Core schema for Flapr
-- ============================================================
...
CREATE INDEX idx_posts_retry            ON public.posts (next_retry_at)
  WHERE status = 'FAILED' AND retry_count < 3;
CREATE INDEX idx_post_targets_post      ON public.post_targets (post_id);
CREATE INDEX idx_auto_plugs_pending     ON public.auto_plugs (status)
